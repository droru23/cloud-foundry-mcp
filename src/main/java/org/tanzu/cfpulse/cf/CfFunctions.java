...
public class CfFunctions {
    ...
    /*
        Applications
    */
    public Function<Map<String, Object>, McpSchema.CallToolResult> applcationsListFunction() {
        return arguments -> {
    ...
    public Function<Map<String, Object>, McpSchema.CallToolResult> pushApplicationFunction() {
        return arguments -> {
            ...
            PushApplicationRequest.Builder builder = PushApplicationRequest.builder().name(name).path(Paths.get(path));
